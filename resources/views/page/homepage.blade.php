...
<section class="min-h-[450px] flex flex-col justify-center items-center text-white text-center p-8"
    ...
    <div class="flex gap-4 max-w-2xl w-full">
        <input type="text" id="searchInput" placeholder="Cari spot ternyamanmu.." class="flex-1 px-4 py-3 rounded-full text-black outline-none" />
        <button onclick="searchPlaces()" class="px-6 py-3 bg-amber-500 text-white rounded-full font-semibold hover:bg-amber-600">
