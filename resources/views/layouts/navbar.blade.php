    ...
    <nav x-data="{ open: false }" class="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 p-3 shadow-md flex justify-between items-center mx-auto">
        ...
        <div class="md:flex md:items-center md:ms-6 ">
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    <button class="inline-flex ml-2 items-center px-1 py-1 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                ...
                <x-slot name="content">
                    ...
                    <x-dropdown-link :href="route('favorites.index')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 inline mr-2">
